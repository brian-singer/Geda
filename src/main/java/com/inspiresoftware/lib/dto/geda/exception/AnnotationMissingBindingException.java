...
public class AnnotationMissingBindingException extends GeDAException {
	 ...
	 */
	public static enum MissingBindingType {
		DTO_READ, DTO_WRITE, ENTITY_READ, ENTITY_WRITE, PARENT_READ, VIRTUAL_CONVERTER
	};
	 ...
	 *            missing bindig type
	 */
	public AnnotationMissingBindingException(final MissingBindingType type, final String fieldName) {
