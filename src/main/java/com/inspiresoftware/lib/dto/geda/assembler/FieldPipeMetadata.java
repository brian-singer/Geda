 ...
 * @author DPavlov
 */
public class FieldPipeMetadata extends BasePipeMetadata implements
com.inspiresoftware.lib.dto.geda.assembler.meta.FieldPipeMetadata {
	 ...
	 * @param converterKey
	 *            converter to use for this field data piping
	 * @param child
	 *            true if field has {@link com.inspiresoftware.lib.dto.geda.annotations.DtoParent} annotation
	 * @param parentEntityPrimaryKeyField
	 *            must be specified for child=true to use as PK for parent
	 * @param entityRetrieverKey
	 *            must be specified for child=true to use for parent retrieval.
	 */
	public FieldPipeMetadata(final String dtoFieldName, final String entityFieldName, final String dtoBeanKey,
			final String entityBeanKey, final boolean readOnly, final String converterKey, final boolean child,
			final String parentEntityPrimaryKeyField, final String entityRetrieverKey) {
