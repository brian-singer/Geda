...
public class BeanFactoryNotFoundException extends GeDAException {
	 ...
	 */
	public BeanFactoryNotFoundException(final String fieldName, final String beanKey, final boolean dto) {
		super("No factory provided for: " + (dto ? "dto " : "entity ") + fieldName + "@key:" + beanKey);
