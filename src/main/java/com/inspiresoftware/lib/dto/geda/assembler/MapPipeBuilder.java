...
class MapPipeBuilder extends BasePipeBuilder<MapPipeMetadata> {
	 ...
	 *             when data reader/writer cannot be created
	 * @throws InspectionPropertyNotFoundException
	 *             when data reader/writer cannot be created
	 * @throws InspectionScanningException
	 *             when map key reader/writer cannot be created
	 * @throws AnnotationValidatingBindingException
	 *             when map property binding is invalid
	...
	public Pipe build(final AssemblerContext context, final Class dtoClass, final Class entityClass,
			...
			final MapPipeMetadata meta, Pipe pipe) throws InspectionBindingNotFoundException,
			InspectionPropertyNotFoundException, UnableToCreateInstanceException, InspectionScanningException,
		...
		return new MapPipe(context, dtoFieldRead, dtoFieldWrite, entityFieldRead, entityFieldWrite, meta);
	}
