...
public class NotValueConverterException extends GeDAException {
	 ...
	 *            field name of the entity instance
	 * @param converterKey
	 *            bean key to use in converter map
	 */
	public NotValueConverterException(final String dtoFieldName, final String entityFieldName, final String converterKey) {
		super("Required converter: " + converterKey + " is invalid for converting: " + dtoFieldName + " to "
				+ entityFieldName
