...
public class AutobindingClassNotFoundException extends GeDAException {
	...
	/**
	 * @param className
	 *            class that is missing {@link com.inspiresoftware.lib.dto.geda.annotations.Dto} annotation.
	 * @param autobinding
	 *            auto binding class
	 */
	public AutobindingClassNotFoundException(final String className, final String autobinding) {
