...
/**
 * Default DSL registry implementation. Keeps reference to extensible bean factory if one was supplied during
 * construction of this registry.
 *
 * This is a throw away disposable container that should not be used once releaseResources had been invoked.
 *
 * @since 2.1.0
 *
 *        User: denispavlov Date: 12-09-20 Time: 1:16 PM
 */
