...
public abstract class AbstractPlainTextMethodSynthesizer extends AbstractMethodSynthesizer implements MethodSynthesizer {
	 ...
	 *
	 * @param readMethodCode
	 *            string builder that hold source for method
	 * @param getReturnTypeMethodCode
	 *            string builder that hold source for method
	 ...
	 *             any exceptions during compilation
	 */
	protected final void generateReaderMethods(final StringBuilder readMethodCode,
			final StringBuilder getReturnTypeMethodCode, final String readerClassName,
			final String sourceClassNameFull, final String sourceClassGetterMethodName,
	 ...
	 *
	 * @param writeMethodCode
	 *            writer method code
	 * @param getParameterTypeMethodCode
	 *            parameter type getter code
	 ...
	 */
	protected final void generateWriterMethods(final StringBuilder writeMethodCode,
			final StringBuilder getParameterTypeMethodCode, final String writerClassName,
			final String sourceClassNameFull, final String sourceClassSetterMethodName,
		...
		.append(sourceClassNameFull).append(" clazz = (").append(sourceClassNameFull).append(") source;\n")
		...
		.append(argType.getMethodArgType()).append(".class;\n").append("}");
	...
	private void appendPrimitiveValue(final String primitiveTypeName, final StringBuilder toAppendTo,
			final String valueOf) {

		toAppendTo.append("((").append(PRIMITIVE_TO_WRAPPER.get(primitiveTypeName)).append(") ").append(valueOf)
		.append(")").append(WRAPPER_TO_PRIMITIVE.get(primitiveTypeName));
