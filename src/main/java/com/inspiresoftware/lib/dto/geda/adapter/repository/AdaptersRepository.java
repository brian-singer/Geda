 ...
 *
 * <p/>
 * User: Denis Pavlov Date: Jan 26, 2010 Time: 4:11:13 PM
 */
public interface AdaptersRepository extends DisposableContainer, Serializable {
	 ...
	 *            converter key
	 * @param adapter
	 *            adapter to register converter to register (ValueCnverter, EntityRetriever, DtoToEntityMatcher)
	 */
	 ...
	 *            adapter key
	 * @param adapter
	 *            adapter to register (ValueCnverter, EntityRetriever, DtoToEntityMatcher)
	 * @throws com.inspiresoftware.lib.dto.geda.exception.DuplicateValueConverterKeyException
	 *             in case if key is already used in this repository.
	 */
	void registerAdapter(String key, Object adapter) throws DuplicateValueConverterKeyException;

	/**
	 * Removes adapter under specified key. If no adapter uses this key in this repository silently does nothing.
	 *
	 * @param key
	 *            adapter key
	 */
