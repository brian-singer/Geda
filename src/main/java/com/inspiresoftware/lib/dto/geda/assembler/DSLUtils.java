 ...
 *
 * User: denispavlov Date: 13-04-24 Time: 8:26 AM
 */
public class DSLUtils {
	 ...
	 *
	 * @param clazz
	 *            class to scan for fields getters.
	 * @return field map
	 */
	protected Map<String, String> scanGetterNamesOnClass(final Class clazz) {
		...
		for (final Method method : clazz.getMethods()) {
			...
			if (method.getTypeParameters().length == 0 && methodName.length() > 3 && methodName.startsWith("get")) {
