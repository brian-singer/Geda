...
public interface PipeMetadata {
	 ...
	 *             if no factory is specified for creating bean instance
	 * @throws BeanFactoryUnableToCreateInstanceException
	 *             if bean cannot be create using factory provided
	 */
	Object newDtoBean(BeanFactory factory) throws BeanFactoryNotFoundException,
	 ...
	 *             if bean cannot be create using factory provided
	 */
	Object newEntityBean(BeanFactory factory) throws BeanFactoryNotFoundException,
	BeanFactoryUnableToCreateInstanceException;
