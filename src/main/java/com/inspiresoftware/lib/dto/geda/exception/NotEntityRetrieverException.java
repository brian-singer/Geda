...
public class NotEntityRetrieverException extends GeDAException {
	 ...
	 */
	public NotEntityRetrieverException(final String dtoFieldName, final String entityFieldName,
			final String converterKey) {
		super("Required retriever: " + converterKey + " is invalid for retrieving: " + entityFieldName + " for "
				+ dtoFieldName
