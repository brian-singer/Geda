...
/**
 * Annotation proxy factory that hides some of the complexity by providing static wrappers for same classloader
 * annotations and reflection proxies for external class loaders.
 *
 * @since 3.0.0
 *
 *        User: denispavlov Date: 13-02-21 Time: 11:41 AM
 */
public final class AnnotationProxies {
	 ...
	 *
	 * @param clazz
	 *            class to discover @Dto annotation for
	 *
	...
	public static AnnotationProxy getClassAnnotationProxy(Class clazz) {
		for (final Annotation annotation : clazz.getDeclaredAnnotations()) {
			...
			} else if ("com.inspiresoftware.lib.dto.geda.annotations.Dto".equals(getAnnotationTrueClass(annotation)
					.getCanonicalName())) {
	...
	static {
		REFLECTIVE_PROPERTIES.put("com.inspiresoftware.lib.dto.geda.annotations.DtoField", new String[] { "value",
				"converter", "readOnly", "entityBeanKeys", "dtoBeanKey" });
		REFLECTIVE_PROPERTIES.put("com.inspiresoftware.lib.dto.geda.annotations.DtoParent", new String[] { "value",
		"retriever" });
		REFLECTIVE_PROPERTIES.put("com.inspiresoftware.lib.dto.geda.annotations.DtoVirtualField", new String[] {
				"converter", "readOnly", "entityBeanKeys", "dtoBeanKey" });
		REFLECTIVE_PROPERTIES.put("com.inspiresoftware.lib.dto.geda.annotations.DtoCollection", new String[] { "value",
				"readOnly", "entityCollectionClass", "entityCollectionClassKey", "dtoCollectionClass",
				"dtoCollectionClassKey", "entityBeanKeys", "dtoBeanKey", "entityGenericType", "entityGenericTypeKey",
				"dtoToEntityMatcher", "dtoToEntityMatcherKey" });
		REFLECTIVE_PROPERTIES.put("com.inspiresoftware.lib.dto.geda.annotations.DtoMap", new String[] { "value",
				"readOnly", "entityMapOrCollectionClass", "entityMapOrCollectionClassKey", "dtoMapClass",
				"dtoMapClassKey", "entityBeanKeys", "dtoBeanKey", "entityGenericType", "entityGenericTypeKey",
				"entityCollectionMapKey", "useEntityMapKey", "dtoToEntityMatcher", "dtoToEntityMatcherKey" });
	}
	 ...
	 *
	 * @param field
	 *            field to discover annotation for
	 *
	...
	public static Map<String, AnnotationProxy> getFieldAnnotationProxy(Field field) {
		...
		for (final Annotation annotation : field.getDeclaredAnnotations()) {
			if (annotation instanceof DtoField) {
				...
				anns.put("DtoVirtualField", new LocalClassLoaderDtoVirtualFieldAnnotationProxy(
						(DtoVirtualField) annotation));
				...
				if (properties != null) {
					anns.put(annClass.getSimpleName(), new ReflectionAnnotationProxy(annotation, properties));
				}
			}
		}
		return anns;
