...
public class CollectionEntityGenericReturnTypeException extends GeDAException {
	...
	/**
	 * @param dtoName
	 *            class name of the dto instance
	 * @param fieldName
	 *            field name of the dto instance
	 * @param entityGenericType
	 *            class of the entity instance
	 */
	public CollectionEntityGenericReturnTypeException(final String dtoName, final String fieldName,
			final String entityGenericType) {
		super("A mismatch in return type of entity is detected," + "please check @DtoCollection.entityGenericType("
				+ entityGenericType + ") of " + fieldName + "[" + dtoName + "]");
