...
/**
 * Interface to trace back from a specific field context to
 * {@link com.inspiresoftware.lib.dto.geda.dsl.DtoEntityContext}.
 *
 * @since 3.0.0
 *
 *        User: denispavlov Date: 13-02-20 Time: 8:42 AM
 */
