 ...
 * @since 3.0.0
 *
 *        User: denispavlov Date: 13-02-20 Time: 9:26 AM
 */
public final class Registries {
	 ...
	 *
	 * @param classLoader
	 *            class loader to use for bean factory
	 *
	 * @return new registry instance
	 */
	...
	/**
	 * Get bean factory from DSL registry. If registry implements BeanFactory then cast and return.
	 *
	 * @param registry
	 *            registry
	 *
