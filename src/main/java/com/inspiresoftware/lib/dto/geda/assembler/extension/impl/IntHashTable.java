...
/**
 * This is an adoption of java.util.HashMap implementation to better support caching mechanisms of GeDA.
 *
 * Basic principles to cache against hashCode, so we want to refrain from using Integer since we use primitive int.
 *
 * @param <V>
 *            type of value
 *
