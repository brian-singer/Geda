...
public interface CollectionPipeMetadata extends PipeMetadata {
	 ...
	 */
	Collection newDtoCollection(BeanFactory beanFactory) throws UnableToCreateInstanceException,
	 ...
	 *             if no bean factory provided
	 */
	Collection newEntityCollection(BeanFactory beanFactory) throws UnableToCreateInstanceException,
	BeanFactoryNotFoundException;
