...
interface Pipe {
	 ...
	 * @param dto
	 *            the dto to write data to.
	 * @param converters
	 *            the converters to be used during conversion.
	 * @param dtoBeanFactory
	 *            bean factory for creating new instances of nested DTO's.
	 *
	 * @throws AnnotationMissingException
	 *             missing {@link com.inspiresoftware.lib.dto.geda.annotations.Dto} in sub DTO's
	 * @throws BeanFactoryUnableToCreateInstanceException
	 ...
	 */
	void writeFromEntityToDto(final Object entity, final Object dto, final Map<String, Object> converters,
	 ...
	 *
	 * @param entity
	 *            the entity to write data to.
	 * @param dto
	 *            the dto to read data from.
	 * @param converters
	 *            the converters to be used during conversion.
	 * @param entityBeanFactory
	 *            bean factory for creating new instances of nested domain objects mapped to DTO.
	 *
	 * @throws EntityRetrieverNotFoundException
	 *             when entity retriever is not found in #converters map
	 * @throws NotEntityRetrieverException
	 *             when retriever in #converters is not valid
	 * @throws BeanFactoryUnableToCreateInstanceException
	 *             when bean factory unable to create instance of sub entity
	 * @throws BeanFactoryNotFoundException
	 *             when bean factory is not provided
	 * @throws ValueConverterNotFoundException
	 *             if value converter is not found in #converters map
	 * @throws NotValueConverterException
	 *             if converter under given key is not a valid converter
	 * @throws AnnotationMissingException
	 *             when sub DTO is missing {@link com.inspiresoftware.lib.dto.geda.annotations.Dto}
	 * @throws AnnotationMissingBeanKeyException
	 *             when DTO does not specify correct key for Entity instances
	 * @throws UnableToCreateInstanceException
	 *             if unable to create instances of collections
	 * @throws CollectionEntityGenericReturnTypeException
	 *             thrown by collection pipe on mismatch of items of collection
	 * @throws InspectionInvalidEntityInstanceException
	 *             if sub entity assembler encounters a mismatch
	 * @throws InspectionInvalidDtoInstanceException
	 *             if sub entity assembler encounters a mismatch
	 ...
	 *             converters
	 */
	void writeFromDtoToEntity(final Object entity, final Object dto, final Map<String, Object> converters,
