...
public class InspectionBindingNotFoundException extends GeDAException {
	 ...
	 *            field name of the dto instance
	 */
	public InspectionBindingNotFoundException(final String dtoClassName, final String dtoFieldName,
			final String entityClassName, final String entityFieldName) {
		super("Unable to bind Dto field '" + dtoClassName + "#" + dtoFieldName + "' to '" + entityClassName + "#"
				+ entityFieldName + "'");
