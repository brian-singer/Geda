...
/**
 * Repository for all adapters. Rationale - default implementation to provide basic support for value transfer.
 * <p/>
 * User: Denis Pavlov Date: Jan 26, 2010 Time: 4:13:40 PM
 */
public class AdaptersRepositoryImpl implements AdaptersRepository {
	...
	/** {@inheritDoc} */
	@Override
	public void registerAdapter(final String key, final Object adapter) throws DuplicateValueConverterKeyException {
