...
public class BeanFactoryUnableToCreateInstanceException extends GeDAException {
	 ...
	 */
	public BeanFactoryUnableToCreateInstanceException(final String factoryToString, final String fieldName,
			final String beanKey, final boolean dto) {
		super("Unable to construct " + (dto ? "dto " : "entity ") + " bean with key: " + beanKey
