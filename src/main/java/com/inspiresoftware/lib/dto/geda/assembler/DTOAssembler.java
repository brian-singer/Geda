...
public final class DTOAssembler {
	...
	/**
	 * String that defines key for pattern for blacklisting entity class names. E.g. Javasist implementation enhances
	 * classes by subclassing and adding _$$_javasist prefix. This pattern will allow to detect these classes and look
	 * up parent class names to overcome class cast exceptions.
	 */
	...
	private static Pattern entityClassNameBlacklistPatternValue = Pattern
			.compile(SETTING_ENTITY_CLASS_NAME_BLACKLIST_PATTERN_DEFAULT);
	 ...
	 * <li>Dynamic classes cache - that caches the instances of
	 * {@link com.inspiresoftware.lib.dto.geda.assembler.extension.DataReader}s and
	 * {@link com.inspiresoftware.lib.dto.geda.assembler.extension.DataWriter}s</li>
	 * </ul>
	 *
	 * @param props
	 *            properties with key specified by DTOAssembler.SETTINGS_* keys
	 *
	 * @throws NumberFormatException
	 *             if the number of cycles specified in properties cannot be converted to int.
	 * @throws GeDAException
	 *             if any of the configurations cause exception
	 */
	...
	private static Assembler createNewAssembler(final Class<?> dto, final Class<?> entity,
			final ClassLoader classLoader, final Object synthesizer, final Registry registry)
		...
		return new DTOtoEntityAssemblerImpl(dto, entity, classLoader, new MethodSynthesizerProxy(classLoader,
				synthesizer), registry);
	}

	private static Assembler createNewAssembler(final Class<?> dto, final Class<?>[] entities,
			final ClassLoader classLoader, final Object synthesizer, final Registry registry)
					throws InspectionScanningException, UnableToCreateInstanceException, InspectionPropertyNotFoundException,
					InspectionBindingNotFoundException, AnnotationMissingBindingException,
					AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
		...
		if (synthesizer instanceof MethodSynthesizerProxy) {
			return new DTOtoEntitiesAssemblerDecoratorImpl(dto, entities, classLoader, (MethodSynthesizer) synthesizer,
					registry);
		}
		return new DTOtoEntitiesAssemblerDecoratorImpl(dto, entities, classLoader, new MethodSynthesizerProxy(
				classLoader, synthesizer), registry);
	}
	...
	private static AnnotationProxy getDtoAnnotationAuto(final Class<?> dto) throws AnnotationMissingException,
	AnnotationMissingAutobindingException {
		final AnnotationProxy ann = AnnotationProxies.getClassAnnotationProxy(dto);
		if (!ann.annotationExists()) {
			throw new AnnotationMissingException(dto.getCanonicalName());
		}
	...
	private static Class[] detectAutobinding(final Class<?> dto) throws AutobindingClassNotFoundException {
	...
	private static <DTO, Entity> int createAssemblerKey(final Class<DTO> dto, final Class<Entity> entity,
			final Object synthesizer, final Registry registry) {
	...
	private static <DTO, Entity> int createAssemblerKey(final Class<DTO> dto, final Class<Entity>[] entities,
			final Object synthesizer, final Registry registry) {
	...
	/**
	 * @param dto
	 *            Dto concrete class that is annotated.
	 * @param entity
	 *            the entity class or interface that has appropriate getters and setters
	 * @param synthesizer
	 *            custom method synthesizer to use (see
	 *            {@link com.inspiresoftware.lib.dto.geda.assembler.MethodSynthesizerProxy} )
	 * @return assembler instance for this conversion.
	 *
	 * @throws AnnotationMissingException
	 *             if dto class is missing the {@link com.inspiresoftware.lib.dto.geda.annotations.Dto} annotation.
	 * @throws InspectionInvalidDtoInstanceException
	 *             if dto instance used for read/write operation is not valid
	 * @throws InspectionInvalidEntityInstanceException
	 *             if entity instance used for read/write operation is not valid
	 * @throws AnnotationDuplicateBindingException
	 *             if during mapping scan same dto field is mapped more than once
	 ...
	 *             in case binding create has a mismatching return type/parameters
	 * @throws AnnotationMissingBindingException
	 *             in case when no valid property on entity is specified to bind to
	 * @throws InspectionBindingNotFoundException
	 *             in case when no valid property on entity is found to bind to
	 * @throws InspectionPropertyNotFoundException
	 *             in case a binding field cannot be found
	 * @throws UnableToCreateInstanceException
	 *             if an instance of an auto created class (one that is directly created by GeDA) cannot be instantiated
	 * @throws InspectionScanningException
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCustomAssembler(final Class<?> dto, final Class<?> entity, final Object synthesizer)
			throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
	 ...
	 *            the entity class or interface that has appropriate getters and setters
	 * @param classLoader
	 *            class loader for object graph serviced by this assembler
	 * @param synthesizer
	 *            custom method synthesizer to use (see
	 *            {@link com.inspiresoftware.lib.dto.geda.assembler.MethodSynthesizerProxy} )
	 * @return assembler instance for this conversion.
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCustomAssembler(final Class<?> dto, final Class<?> entity,
			final ClassLoader classLoader, final Object synthesizer) throws AnnotationMissingException,
		...
		return putAssemblerToCache(classLoader, key,
				createNewAssembler(dto, realEntity, classLoader, synthesizer, null));
	}
	 ...
	 *            the entity class or interface that has appropriate getters and setters
	 * @param registry
	 *            DSL registry that contains all mappings
	 * @param synthesizer
	 *            custom method synthesizer to use (see
	 *            {@link com.inspiresoftware.lib.dto.geda.assembler.MethodSynthesizerProxy} )
	 * @return assembler instance for this conversion.
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCustomAssembler(final Class<?> dto, final Class<?> entity, final Registry registry,
			final Object synthesizer) throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
			InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
			InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 */
	public static Assembler newCustomAssembler(final Class<?> dto, final Class<?> entity,
			final ClassLoader classLoader, final Registry registry, final Object synthesizer)
					throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
					InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
					InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
					AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
		...
		return putAssemblerToCache(classLoader, key,
				createNewAssembler(dto, realEntity, classLoader, synthesizer, registry));
	}
	 ...
	 *            Dto concrete class that is annotated.
	 * @param entities
	 *            the entity classes or interfaces that have appropriate getters and setters
	 * @param synthesizer
	 *            custom method synthesizer to use (see
	 *            {@link com.inspiresoftware.lib.dto.geda.assembler.MethodSynthesizerProxy} )
	 * @return assembler instance for this conversion.
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCustomCompositeAssembler(final Class<?> dto, final Class<?>[] entities,
			final Object synthesizer) throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
			InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
			InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newAssembler(final Class<?> dto, final Class<?> entity) throws AnnotationMissingException,
	InspectionInvalidDtoInstanceException, InspectionInvalidEntityInstanceException,
	InspectionScanningException, UnableToCreateInstanceException, InspectionPropertyNotFoundException,
	InspectionBindingNotFoundException, AnnotationMissingBindingException,
	AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newAssembler(final Class<?> dto, final Class<?> entity, final ClassLoader classLoader)
			throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
			InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
			InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newAssembler(final Class<?> dto, final Class<?> entity, final Registry registry)
	 ...
	 */
	public static Assembler newAssembler(final Class<?> dto, final Class<?> entity, final ClassLoader classLoader,
			final Registry registry) throws InspectionInvalidDtoInstanceException,
			InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
			InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 *            Dto concrete class that is annotated.
	 * @param entities
	 *            the entity classes or interfaces that has appropriate getters and setters
	 * @return assembler instance for this conversion.
	 *
	 * @throws AnnotationMissingException
	 *             if dto class is missing the {@link com.inspiresoftware.lib.dto.geda.annotations.Dto} annotation.
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCompositeAssembler(final Class<?> dto, final Class<?>[] entities)
			throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
			InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
			InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 */
	public static Assembler newCompositeAssembler(final Class<?> dto, final Class<?>[] entities,
			final ClassLoader classLoader) throws AnnotationMissingException, InspectionInvalidDtoInstanceException,
			InspectionInvalidEntityInstanceException, InspectionScanningException, UnableToCreateInstanceException,
			InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {

		final MethodSynthesizer synthesizer = getDefaultSynthesizer(classLoader);
		final int key = createAssemblerKey(dto, entities[0], synthesizer, null);
	...
	/**
	 * @param dto
	 *            Dto concrete class that is annotated and value attribute of Dto is supplied.
	 * @param synthesizer
	 *            custom method synthesizer to use (see
	 *            {@link com.inspiresoftware.lib.dto.geda.assembler.MethodSynthesizerProxy} )
	 * @return assembler instance for this conversion.
	 ...
	 *             if autobinding parameter is missing
	 * @throws AutobindingClassNotFoundException
	 *             if class specified for auto binding cannot be found
	 * @throws AnnotationDuplicateBindingException
	 *             if same field name is mapped more than once
	 * @throws GeDARuntimeException
	 *             unhandled cases - this is (if GeDA was not tampered with) means library failure and should be
	 *             reported
	 * @throws AnnotationValidatingBindingException
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCustomAssembler(final Class<?> dto, final Object synthesizer)
			throws AnnotationMissingAutobindingException, AutobindingClassNotFoundException,
			InspectionScanningException, UnableToCreateInstanceException, InspectionPropertyNotFoundException,
			InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newCustomAssembler(final Class<?> dto, final ClassLoader classLoader,
			final Object synthesizer) throws AnnotationMissingAutobindingException, AutobindingClassNotFoundException,
			InspectionScanningException, UnableToCreateInstanceException, InspectionPropertyNotFoundException,
			InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
		...
		if (classes.length == 1) {
			return putAssemblerToCache(classLoader, key,
					createNewAssembler(dto, classes[0], classLoader, synthesizer, null));
		}
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newAssembler(final Class<?> dto) throws AnnotationMissingAutobindingException,
	AutobindingClassNotFoundException, InspectionScanningException, UnableToCreateInstanceException,
	InspectionPropertyNotFoundException, InspectionBindingNotFoundException, AnnotationMissingBindingException,
	AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	 ...
	 *             general error that may occur during scanning a class for fields and method descriptors
	 */
	public static Assembler newAssembler(final Class<?> dto, final ClassLoader classLoader)
			throws AnnotationMissingAutobindingException, AutobindingClassNotFoundException,
			InspectionScanningException, UnableToCreateInstanceException, InspectionPropertyNotFoundException,
			InspectionBindingNotFoundException, AnnotationMissingBindingException,
			AnnotationValidatingBindingException, GeDARuntimeException, AnnotationDuplicateBindingException {
	...
	/**
	 * Dispose of all GeDA caches and references for given class loader. This is useful when you wish to unload a
	 * particular module of your application and ensure no memory leaks occur. An example use would be undeploying an
	 * OSGi bundle.
	 *
	 * @param classLoader
	 *            class loader to clean references for
	 */
