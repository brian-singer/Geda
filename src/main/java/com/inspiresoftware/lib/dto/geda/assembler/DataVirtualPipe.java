...
class DataVirtualPipe implements Pipe {
	 ...
	 */
	public DataVirtualPipe(final DataReader dtoRead, final DataWriter dtoWrite, final FieldPipeMetadata meta)
			throws AnnotationMissingBindingException, AnnotationValidatingBindingException {
