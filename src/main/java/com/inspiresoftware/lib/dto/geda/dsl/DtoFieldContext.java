 ...
 * @since 3.0.0
 *
 *        User: denispavlov Date: 13-02-20 Time: 8:44 AM
 */
public interface DtoFieldContext extends DtoEntityContextAppender {
	...
	/**
	 * Textual reference to a converter to use when assembling DTO's and Entities. This reference is used to lookup
	 * converter in adapters map passed into assembleDto and assembleEntity methods. This converter must implement
	 * {@link com.inspiresoftware.lib.dto.geda.adapter.ValueConverter}.
	 *
	 * @param converter
	 *            converter key (requires adapters parameter during assembly)
	 * @return dto field context
	 */
	DtoFieldContext converter(String converter);

	/**
	 * This annotation is mandatory with deeply nested entity object i.e. when a '.' syntax is used. Failure to supply
	 * this parameter will result in {@link com.inspiresoftware.lib.dto.geda.exception.GeDAException}.
	 *
	...
	/**
	 * This annotation is mandatory for nested objects that are used as fields within the top level DTO.
	 *
	 ...
	 * field name on entity class that will be bound to this dto field (reflection notation e.g. myField.mySubfield).
	 *
	 * This fields value will be passed on to {@link com.inspiresoftware.lib.dto.geda.adapter.EntityRetriever} as
	 * primary key.
	 *
	 * @param primaryKeyFieldName
	 *            field that is a PK for entity retrieval
