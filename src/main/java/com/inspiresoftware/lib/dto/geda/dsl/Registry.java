...
/**
 * Registry allows user to use DSL style mapping for DTO objects. When methods are invoked all information is stored
 * within registry and kept for when it is used with assembler.
 *
 * @since 3.0.0
 *
 *        User: denispavlov Date: 13-02-20 Time: 9:15 AM
 */
