...
/**
 * Reflection implementation of method synthesizer. Least efficient implementation, yet the most stable one since it
 * does not require auto generation of classes during runtime.
 *
 * @author denispavlov
 * @since 1.1.2
 *
...
public class ReflectionMethodSynthesizer extends AbstractMethodSynthesizer implements MethodSynthesizer {
	...
	protected DataReader makeReaderClass(final ClassLoader loader, final Method readMethod,
		...
		if (sourceClassGetterMethodReturnType instanceof Class) {
			...
			returnType = (Class<?>) ((ParameterizedType) sourceClassGetterMethodReturnType).getRawType();
