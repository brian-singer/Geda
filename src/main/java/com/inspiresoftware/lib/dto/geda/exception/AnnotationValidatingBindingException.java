...
public class AnnotationValidatingBindingException extends GeDAException {
	 ...
	 *            dto field
	 * @param dtoBinder
	 *            dto reader/writer class name
	 * @param dtoBinderClass
	 *            class of the return type/parameter for dto reader/writer
	 * @param entityField
	 *            entity field
	 * @param entityBinder
	 *            entity reader/writer class name
	 * @param entityBinderClass
	 *            class of the return type/parameter for entity reader/writer
	 * @param dtoRead
	 *            true if dto binder is a reader, false if it is a writer
	 */
	public AnnotationValidatingBindingException(final String dtoField, final String dtoBinder,
			final String dtoBinderClass, final String entityField, final String entityBinder,
			final String entityBinderClass, final boolean dtoRead) {
		super("Type mismatch is detected for: DTO " + dtoField + (dtoRead ? " read" : " write") + " {" + dtoBinder
				+ "[" + dtoBinderClass + "]} " + "and Entity " + entityField + (dtoRead ? " write" : " read") + " {"
				+ entityBinder + "[" + entityBinderClass + "]}. Consider using a converter.");
